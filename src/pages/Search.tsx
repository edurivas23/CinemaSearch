    ...
    return (
        <main className="flex-1 p-10">
            <section className="w-full h-full mb-20">
                <form onSubmit={handleSubmit} className="w-full py-4  bg-black/60 ring-2 ring-purple-950/20 text-white rounded-lg shadow-xl/20 px-4 focus-within:ring-white">
                    <input
                        autoFocus
                        ref={inputRef}
                    ...
                    {loading
                        ...
                        : allMovies.length === 0
                            ? <div className="flex flex-col items-center justify-center text-6xl text-white text-center gap-20">
                                ...
                                <img src="https://cdn-icons-png.flaticon.com/512/2171/2171949.png"alt="Dibujo de un perro llorando" className="w-50" />
                            </div>
                            : <>
